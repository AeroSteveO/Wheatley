...
/**
 * This class handles a log of messages for a set of channels.
 * It maps a List of username and messages to a channel name.
 * @author Stephen
 */
public class MapArray {
  ...
  /**
   * Determines if the log for the input channel is empty. Returns true if
   * the log List is empty, and false otherwise.
  ...
  /**
   * Adds the input message List to the input channel's log. The message
   * list should be formatted as a list containing the username in the
   * first element, and the message in the second.
