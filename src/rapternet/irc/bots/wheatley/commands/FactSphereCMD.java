 ...
 * @author Stephen
 */
public class FactSphereCMD implements Command {
    ArrayList<String> quotels = getQuoteList();
    
    @Override
    public String toString() {
        return("Fact Sphere: Gives insightful facts about life, the universe, and everything");
    }
    ...
    public void processCommand(Event event) {
        ...
        event.getBot().sendIRC().message(respondTo,"Fact: " + fact);
    }
